...
<a href="logout.php">logout</a>
    ...
    <form action="" method="post">
        <input type="text" name=keyword autocomplete="off" placeholder="Masukkan kata kunci" size="40" id="keyword">
        <button type="submit" name="cari" keyword="tombol-cari">Cari</button>
    </form>
    <br>
    <br>
    <!-- navigasi -->
